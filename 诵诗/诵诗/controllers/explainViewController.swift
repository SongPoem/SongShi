...
class explainViewController: UIViewController{
    ...
    func setPoet(){
        ...
        poet.backgroundColor = UIColor(red: 0, green: 0, blue: 0, alpha: 0)
    ...
    func setPoem(){
        ...
        poem.backgroundColor = UIColor(red: 240/255, green: 237/255, blue: 233/255, alpha: 0)
        ...
        para.lineSpacing = 10
        let attribute = [NSAttributedStringKey.paragraphStyle: para, NSAttributedStringKey.font: UIFont(name: "FZQingKeBenYueSongS-R-GB", size: 18), NSAttributedStringKey.foregroundColor: UIColor(red: 97/255, green: 97/255, blue: 97/255, alpha: 1)]
    ...
    func getStatement(){
        ...
        if searchViewController.flag {
            stmt = searchViewController.stmt
    ...
    @IBAction func toComment(_ sender: UIButton) {
        UserDefaults.standard.set(poemName.text!, forKey: "poemName")

        var id = 0
        if let temp = UnsafePointer(sqlite3_column_text(stmt, 0)){
            id = Int(String.init(cString: temp))!
        }
        UserDefaults.standard.set(id, forKey: "poemChosen")
    ...
    @objc func jumpTo(){
        ...
        if searchViewController.flag {
            ...
            searchViewController.flag = false
        } else {
            //否则
...
//        comment.setImage(UIImage(named: "评论未选中.png"), for: UIControlState.normal)
//        comment.setImage(UIImage(named: "评论选中.png"), for: UIControlState.selected)
