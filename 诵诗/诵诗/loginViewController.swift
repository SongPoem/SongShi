...
class loginViewController: UIViewController, UITextFieldDelegate {
    ...
    func initTextField(){
        ...
        username.attributedPlaceholder = NSAttributedString(string: "【         用户名          】", attributes: [NSFontAttributeName: UIFont.init(name: "FZQingKeBenYueSongS-R-GB", size: 20.0)!, NSForegroundColorAttributeName: UIColor.init(colorLiteralRed: 78/255.0, green: 78/255.0, blue: 78/255.0, alpha: 1)])
        username.delegate = self
        
        passwd.borderStyle = .none
        passwd.attributedPlaceholder = NSAttributedString(string: "【           密码            】", attributes: [NSFontAttributeName: UIFont.init(name: "FZQingKeBenYueSongS-R-GB", size: 20.0)!, NSForegroundColorAttributeName: UIColor.init(colorLiteralRed: 78/255.0, green: 78/255.0, blue: 78/255.0, alpha: 1)])
