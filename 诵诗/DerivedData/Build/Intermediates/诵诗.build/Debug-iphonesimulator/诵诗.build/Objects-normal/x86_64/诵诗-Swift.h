...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified feihua;
...
@interface gamemViewController : UIViewController <UIScrollViewDelegate, UITextFieldDelegate, UITextViewDelegate>
...
@property (nonatomic, readonly, copy) NSArray<NSString *> * _Nonnull gameTitleArr;
